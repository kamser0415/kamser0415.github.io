...
톰캣에서 현재 문열고 들어온 인원을 제한하기 위해 사용하는 필드입니다.

전체 작업하는 사람 5명,  작업하기 위해 대기줄에 줄선 인원 10명 , 대기줄에 들어가고 싶어서 서로 밀어내는 10명이 있습니다.

총인원은 25명이며 maxConnections는 설정 값에 따라 내부 자원이 풍부해도 단순한 숫자락값으록

> 설명
>
> 너무 낮으면 접속 실패에는 모니터링을 통해 점진적으로 볼리느 전략이 필요가 습니다.
